...
from indextts.gpt.transformers_gpt2 import GPT2Model, GPT2PreTrainedModel
        ...
        **hf_generate_kwargs,
        ...
        if cond_mel_lengths is None:
            cond_mel_lengths = torch.tensor(
                [speech_conditioning_mel.shape[-1]],
                device=speech_conditioning_mel.device,
            )
